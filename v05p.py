...
with st.sidebar.expander("Sneltoetsen & Werking"):
    ...
    **Opmerking:**  
    - <kbd>t</kbd> : Toon/verberg opmerking  
...
if uploaded_file:
    try:
        ...
        # --- Knoppen en slider (zonder opslaan-knop) ---
        ...
        # --- Permanent commentaarveld (Enter = opslaan) ---
        ...
        with st.form(key="comment_form"):
            new_comment = st.text_area(
                ...
                placeholder="TAB Enter om op te slaan",
            )
        ...
        # --- Info ---
        st.info("Hotkeys: j/k (navigatie), g/f (goed/fout),  Esc (wissen)")
